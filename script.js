...
function apri(chiave) {
    ...
    // --- AGGIUNTA SICURA PER SECONDA IMMAGINE ---
    var extra = document.getElementById('img-extra-modale');
    if (extra) { extra.remove(); } // Pulisce se c'era prima

    if(immagine) { 
        f.src = immagine; 
        f.style.display = "block"; 
        
        // Se è il tatuaggio, aggiungiamo la mano con la cicatrice sotto
        if (chiave === 'tatuaggio') {
