...
function apri(chiave) {
    ...
    else if(chiave === 'tatuaggio') {
        tris.style.display = "flex"; controllo.style.display = "none";
        tris.innerHTML = `<img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1770442497/mano-della-cicatrice-44061963_fvopou.jpg" class="foto-tris" style="width:248px; height:auto; margin-top: 10px;">`;
    }
