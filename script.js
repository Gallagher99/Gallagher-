...
function apri(chiave) {
    ...
    // MODIFICA: Mostra la cicatrice solo se la chiave è 'tatuaggio'
    var cicatriceDiv = document.getElementById('extra-cicatrice');
    if(chiave === 'tatuaggio') { cicatriceDiv.style.display = "block"; } else { cicatriceDiv.style.display = "none"; }
