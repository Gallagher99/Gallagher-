const datiGallagher = {
    ...
    'aspetto': ["Aspetto Fisico", `Corporatura: È un uomo dall'ossatura robusta e dalla presenza imponente...`, "https://res.cloudinary.com/dqoncufhc/image/upload/v1768446404/ricordo_znoads.png"],
    'carattere': ["Il Carattere", `L’Uomo del "Vero e Falso": Gallagher è intrinsecamente un bugiardo...`, "https://res.cloudinary.com/dqoncufhc/image/upload/v1768446404/ricordo2_ysvgil.png"]
};
...
function apri(chiave) {
    ...
    if(titolo === 'Il Bambino') {
        ...
        tris.innerHTML = `<img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446390/madre_pz7exh.jpg" class="foto-tris" style="width:90px; height:130px; object-fit:cover; margin: 0 2px;"><img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768575858/bambino_gjx98z.png" class="foto-tris" style="width:90px; height:130px; object-fit:cover; margin: 0 2px;"><img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446403/padre_ebpoxy.jpg" class="foto-tris" style="width:90px; height:130px; object-fit:cover; margin: 0 2px;">`;
    } 
    else if(titolo === "L'Anziano") {
        tris.style.display = "flex"; controllo.style.display = "none";
        tris.innerHTML = `<img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768535131/incontro_wplvdz.png" class="foto-tris" style="width:140px; height:180px; object-fit:cover; margin-right: 5px;"><img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446390/candela_ahabqh.gif" class="foto-tris" style="width:140px; height:180px; object-fit:cover; margin-left: 5px;">`;
    }
    ...
    else if(titolo === "Segni e Tatuaggi") {
        tris.style.display = "flex"; controllo.style.display = "none";
        tris.innerHTML = `<img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1770442497/mano-della-cicatrice-44061963_fvopou.jpg" class="foto-tris" style="width:200px; height:auto; margin-top: 10px;">`;
    }
